...
$switchId = 77;
$data = json_decode(file_get_contents("http://127.0.0.1:8080/json.htm?type=devices&rid=$switchId"));
$chan = $data->result[0]->Level;
...
//    usleep(500);
    ...
    for ($i = 0 ; $i < strlen($chan) ; $i++)
    {
	$key = "E3 0" . substr($chan, $i, 1);
	echo "-----------------------------<br>";
